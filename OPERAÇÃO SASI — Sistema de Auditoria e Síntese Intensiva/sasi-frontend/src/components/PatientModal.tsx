...
import {
  ...
  Plus, Copy, Printer, Check, Swords,
} from 'lucide-react';
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2">
                    ...
                    <div className="flex items-center gap-1.5 ml-auto">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 rounded-lg bg-app-accent/15 hover:bg-app-accent/25 text-app-accent text-[11px] font-bold uppercase tracking-wide transition border border-app-accent/30"
                        title="Sala de Guerra — visão tática 2x2"
                      >
